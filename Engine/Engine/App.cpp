...
{
    isPlaying = true;
    LOG(LogType::LOG_INFO, "Game started");
}

void App::Stop()
{
    isPlaying = false;
    LOG(LogType::LOG_INFO, "Game stopped");
    SaveGameState();
}

void App::SaveGameState()
{
    // Implementa la lógica para guardar el estado del juego
    LOG(LogType::LOG_INFO, "Game state saved");
}